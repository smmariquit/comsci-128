  ...
  return (
    ...
    >
      ...
      >
        ...
        <input
          ...
          style={{
            ...
            width: "100%",
            paddingLeft: 32,
            boxShadow: hoveredInput ? "0 8px 18px rgba(28,38,50,0.08)" : "none",
      ...
      <select
        ...
        onMouseLeave={() =>
          setHoveredSelect((current) =>
            current === "occupancy" ? null : current,
          )
        }
        style={{
          ...selectBase,
          minWidth: 160,
          boxShadow:
            hoveredSelect === "occupancy"
              ? "0 8px 18px rgba(28,38,50,0.08)"
              : "none",
          outlineColor: hoveredSelect === "occupancy" ? C.amber : C.cream,
        }}
      >
        {(
          [
