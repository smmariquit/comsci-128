        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                      ...
                      style={{
                        ...
                        transform:
                          removeHover === t.id
                            ...
                            : "translateY(0)",
                        textDecoration:
                          removeHover === t.id ? "underline" : "none",
                        transition:
                          "transform 0.15s ease, text-decoration 0.15s ease",
                      }}
                    >
                      Remove
                    </button>
          ...
          {!isFull ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                {students.length === 0 && !loading && (
                  <p style={{ fontSize: 13, color: C.orange, marginTop: 4 }}>
                    ...
                    {room.room_type === "Co-ed"
                      ? ""
                      : room.room_type.replace(" Only", "")}{" "}
                    students found with approved applications.
                  </p>
                )}
              </div>
              ...
              >
                Only students with{" "}
                <strong style={{ color: C.navy }}>Approved</strong> applications
                matching the room type are shown.
              </div>
            </div>
          ) : (
            <div
