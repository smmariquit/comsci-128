...
export const MOCK_OCCUPANCY: OccupancyReportRow[] = [
  ...
  },
  {
    ...
    maximum_occupants: 2,
    current_occupants: 1,
    occupancy_status: "Partially Occupied",
  },
  {
    room_id: 3,
    room_code: "KRH-103",
  ...
  },
  {
    room_id: 6,
    room_code: "IRM-201",
    housing_name: "Ilagan Residence Hall",
    room_type: "Co-ed",
    maximum_occupants: 2,
    current_occupants: 0,
    occupancy_status: "Empty",
...
export const MOCK_APPLICATIONS: ApplicationReportRow[] = [
  {
    ...
    housing_name: "Kalayaan Residence Hall",
    preferred_room_type: "Women Only",
    application_status: "Approved",
    expected_moveout_date: "2025-05-31",
  },
  {
    application_id: 102,
  ...
  },
  {
    ...
    student_number: "2022-00011",
    housing_name: "Ilagan Residence Hall",
    preferred_room_type: "Co-ed",
    application_status: "Approved",
    expected_moveout_date: "2025-06-30",
  },
  {
    application_id: 105,
    student_name: "Lorna Villanueva",
    student_number: "2019-00088",
    housing_name: "Ilagan Residence Hall",
    preferred_room_type: "Co-ed",
    application_status: "Cancelled",
    expected_moveout_date: "2025-06-30",
    actual_moveout_date: "2025-03-15",
  },
  {
    application_id: 106,
    student_name: "Carlos Mendoza",
    student_number: "2023-00033",
    housing_name: "Kalayaan Residence Hall",
    preferred_room_type: "Men Only",
    application_status: "Pending Admin Approval",
    expected_moveout_date: "2025-07-31",
  },
];
...
export const MOCK_ACCOMMODATION: AccommodationHistoryRow[] = [
  {
    ...
    housing_name: "Kalayaan Residence Hall",
    room_type: "Women Only",
    movein_date: "2024-06-01",
    moveout_date: "2024-10-31",
  },
  {
    account_number: 1001,
    student_name: "Maria Santos",
    ...
    housing_name: "Kalayaan Residence Hall",
    room_type: "Women Only",
    movein_date: "2024-11-01",
    moveout_date: "2025-05-31",
  },
  {
    account_number: 1002,
    student_name: "Juan dela Cruz",
  ...
  },
  {
    ...
    housing_name: "Ilagan Residence Hall",
    room_type: "Co-ed",
    movein_date: "2022-06-01",
    moveout_date: "2023-05-31",
  },
];
...
export const ALL_HOUSING = ["Kalayaan Residence Hall", "Ilagan Residence Hall"];
