        ...
        >
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <input
              ...
              onMouseEnter={() => setHoveredFrom(true)}
              onMouseLeave={() => setHoveredFrom(false)}
              style={{
                ...inputBase,
                minWidth: 150,
                boxShadow: hoveredFrom
                  ? "0 8px 18px rgba(28,38,50,0.08)"
                  : "none",
                outlineColor: hoveredFrom ? C.amber : C.cream,
              }}
            />
          </div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <input
              ...
              style={{
                ...
                boxShadow: hoveredTo
                  ? "0 8px 18px rgba(28,38,50,0.08)"
                  : "none",
                outlineColor: hoveredTo ? C.amber : C.cream,
              }}
            />
          </div>
          {(dateFrom || dateTo) && (
