...
export default function HousingImageUpload() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            await housingData.uploadHousingImage(numericId, selectedFile);
            ...
            <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: 18 }}>
                ...
                <div>
                    <label style={{
                        ...
                        fontWeight: 500, color: C.teal, textTransform: "uppercase",
                    ...
                    <input
                        ...
                        style={{
                            ...
                            borderRadius: 8, border: `1px solid ${C.cream}`, fontSize: 13,
                ...
                <div>
                    ...
                    <div style={{
                        minHeight: 160, borderRadius: 12, border: `1px dashed ${C.teal}`,
                        background: "rgba(86,115,117,0.03)", display: "flex", flexDirection: "column",
                        ...
                        {previewUrl ? (
                            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
                                <img
                                    ...
                                    style={{
                                        ...
                                        borderRadius: 8, border: `1px solid ${C.dividerLight}`, marginBottom: 12
                                    }}
                                />
                                {selectedFile && (
                            ...
                            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
                                ...
                                <label style={{
                                    ...
                                    padding: "7px 16px", borderRadius: 8, border: `1px solid ${C.cream}`,
            ...
            <div style={{
                ...
                <button
                    ...
                    style={{
                        ...
                        background: (isUploading || !selectedFile) ? C.cream : C.orange,
