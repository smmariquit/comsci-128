  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gray-950">
      ...
      >
        ...
        {error && <div className="text-red-400 text-center bg-red-400/10 py-2 rounded-lg">{error}</div>}
        ...
        {step === 3 && (
          <div className="text-stone-200 space-y-2 bg-gray-900/50 p-4 rounded-xl border border-gray-700/30">
        ...
        <div className="flex gap-2 mt-4">
          {step > 1 && (
            <button
              type="button"
              className="flex-1 bg-gray-600/50 text-white rounded-3xl py-3 hover:bg-gray-600 transition active:scale-95"
          ...
          {step < 3 && (
            <button
              type="button"
              className="flex-1 bg-orange-300 text-gray-800 font-bold rounded-3xl py-3 hover:bg-orange-400 transition active:scale-95 shadow-lg shadow-orange-300/10"
              onClick={() => setStep(step + 1)}
              disabled={loading}
            >
              Next
        ...
        <div className="text-center text-stone-300 mt-2">
          ...
          <a href="/login" className="font-bold underline text-orange-200">Login</a>
        </div>
        ...
        <button
          type="button"
          className="bg-stone-50 text-black rounded-lg py-3 mt-2 flex items-center justify-center gap-2 font-semibold hover:bg-white transition shadow-md"
          onClick={async () => {
