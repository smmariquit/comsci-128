...
const MOCK_DATA: User[] = [
    { id: "1", name: "Mahoraga", email: "nahidadapt@mappa.com", user_type: "admin" },
    { id: "2", name: "Gojo", email: "hotdogcheesecake@gmail.com", user_type: "student" },
    { id: "3", name: "Robert", email: "marhabadorm@gmail.com", user_type: "landlord" }
];

// checkUserAccess - INPUT: user, allowedRole | OUTPUT: go next (if allowed), 403 (if not)
export const checkUserAccess = (user: User | undefined, allowedRole: string) => {
