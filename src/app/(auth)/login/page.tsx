...
export default function LoginPage() {
  ...
  <div className="w-full min-h-screen flex items-center justify-center bg-gray-950">
    ...
    >
      ...
      {status && (
        <div className={`text-center p-3 rounded-xl ${status.includes("successful") ? "bg-green-900/30 text-green-400" : "bg-red-900/30 text-red-400"}`}>
          {status}
        </div>
      )}
      <input
      ...
      <button
        type="submit"
        className="bg-orange-300 text-gray-800 font-bold rounded-3xl py-3 mt-2 hover:bg-orange-400 transition disabled:opacity-50"
