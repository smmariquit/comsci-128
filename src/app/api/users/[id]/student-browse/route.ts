...
export async function GET(_request: NextRequest, _context: { params?: any }) {
  try {
    ...
    //     "Female" |
    //     "Co-ed";
    const sortByPrice = url.searchParams.get("sort_by_price") as "asc" | "desc";
    ...
    if (!dorms || dorms.length === 0) {
      return NextResponse.json({ message: "No dorms found" }, { status: 404 });
    }
