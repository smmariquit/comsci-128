...
export default function ReviewWrapper({
  ...
  const isApprovedOrRejected = ["Approved", "Rejected", "Cancelled"].includes(
    currentStatus,
  );
      ...
      <div className="w-1/3 flex flex-col gap-4">
        <div className="bg-yellow-50 rounded-xl shadow p-6 text-black space-y-2">
          ...
          <p>
            ...
            <span
              className={`px-2 py-0.5 rounded text-sm font-semibold inline-block ${getStatusStyles(currentStatus)}`}
            >
              {currentStatus}
            </span>
          </p>
