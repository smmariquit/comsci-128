...
export default async function DashboardPage() {
  ...
  return (
    ...
    >
      {/* NAV BAR */}
      <header className="flex min-h-[64px] h-[10vh] w-full max-w-[1440px] bg-[#1C2632] items-center justify-between px-4 sm:px-10 text-sm sm:text-base">
        <div className="flex items-center gap-4 sm:gap-8">
          <h1 className="text-[#EDE9DE] text-xl font-semibold tracking-tight">
            Title
          </h1>

          <nav className="hidden sm:flex items-center gap-6 border-l border-gray-700 pl-8 ">
      ...
      {/* BREAD CRUMBS */}
      <div className="flex flex-col bg-[#567375] px-4 sm:px-[36px] py-[6px] justify-center">
      ...
      <Suspense
        fallback={
          <div className="p-4 text-center text-[#EDE9DE]">
            Loading search...
          </div>
        }
      >
      ...
      <div className="bg-[#EDE9DE] w-[95vw] sm:w-[90vw] p-4 sm:p-6 mx-auto">
        {/* GRID LAYOUT */}
