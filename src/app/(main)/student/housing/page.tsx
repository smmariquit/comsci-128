        ...
        <div style={{ display: "flex", gap: "40px", marginTop: "20px" }}>
          ...
          >
            ...
            {singleDorm && (
              ...
              >
                <p>
                  <strong>Result:</strong> {singleDorm.housing_name}
                </p>
                <p>
                  <strong>Address:</strong> {singleDorm.housing_address}
                </p>
                <p>
                  <strong>Type:</strong> {singleDorm.housing_type}
                </p>
                <p>
                  <strong>Price:</strong> ₱{singleDorm.rent_price}
                </p>
                <button
