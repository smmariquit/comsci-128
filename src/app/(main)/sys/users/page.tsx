...
const stubUsers: User[] = [
	...
	{ id: '6', name: 'Luthelle Fernandez', gender: 'Female', email: 'llfernandez4@up.edu.ph', role: 'Dorm Manager', status: 'Disabled', dormitory: 'Dorm 1', room: 'ROOM #', joined: 'Jan 12, 2024' },
	{ id: '7', name: 'Luthelle Fernandez', gender: 'Female', email: 'llfernandez4@up.edu.ph', role: 'Landlord', status: 'Active',   dormitory: 'Dorm 2', room: 'ROOM #', joined: 'Jan 12, 2024' },
];
