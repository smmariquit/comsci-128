...
const stubUsers: User[] = [
  { id: '1', name: 'Luthelle Fernandez', gender: 'Female', email: 'llfernandez4@up.edu.ph',   status: 'Active',   dormitory: 'Dorm ID#', joined: 'Jan 12, 2024' },
  { id: '2', name: 'Justine Ivanne Antonio', gender: 'Male', email: 'llfernandez4@up.edu.ph', status: 'Active',   dormitory: 'Dorm ID#', joined: 'Jan 12, 2024' },
  { id: '3', name: 'Paul Hadley Fababeir', gender: 'Male', email: 'llfernandez4@up.edu.ph', status: 'Active',   dormitory: 'Dorm ID#', joined: 'Jan 12, 2024' },
  { id: '4', name: 'Jun Paul Omamos', gender: 'Male', email: 'llfernandez4@up.edu.ph', status: 'Disabled', dormitory: 'Dorm ID#', joined: 'Jan 12, 2024' },
  { id: '5', name: 'Joy Guevarra', gender: 'Female', email: 'llfernandez4@up.edu.ph',  status: 'Active',   dormitory: 'Dorm ID#', joined: 'Jan 12, 2024' },
  { id: '6', name: 'Haira Espinocilla', gender: 'Female', email: 'llfernandez4@up.edu.ph',  status: 'Disabled', dormitory: 'Dorm 1',joined: 'Jan 12, 2024' },
  { id: '7', name: 'Althea Fernandez', gender: 'Female', email: 'llfernandez4@up.edu.ph', status: 'Active',   dormitory: 'Dorm 2',joined: 'Jan 12, 2024' },
];
